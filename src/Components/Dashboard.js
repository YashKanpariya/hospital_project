...
function Dashboard() {
    ...
    const [depaSelect, setDepaSelect] = useState()
    const status = 0
    const img = useRef()
    //All Doctors view
    useEffect(() => {
    ...
    const submitData = () => {
        ...
        form.append('depaSelect', depaSelect)
    ...
    const doctorSelectText = (i) => {
        setDoctorSelect(i)
    }
    const departSelectText = (i) => {
        setDepaSelect(i)
    }
    function test(i) {
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-6 col-md-5">
                                            <div className="text-right d-none d-md-block">
                                                <ul className="list-unstyled m-b-0">
                                                    <li><a href="/sign-in" className="btn btn-link">Sign in</a> <a href="/sign-up" className="btn btn-link">sign
                                                        up</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div className="slider" style={{ backgroundImage: 'url(assets/images/slider1.jpg)' }}>
                                    <div className="container">
                                        ...
                                        <div className="slider_form row">
                                            ...
                                            <div className="col-lg-4 col-md-6 col-6">
                                                <div className="form-group date-body">
                                            ...
                                            <div className="col-lg-4 col-md-6 col-6">
                                                <select className="form-control m-b-15" onChange={(i) => doctorSelectText(i.target.value)}>
                                                    <option selected disabled >-- Select Doctor --</option>
                                                    {
                                                        allDoctors.map((i) => {
                                                            return (
                                                                <>
                                                                    <option value={i.fname + " " + i.lname} > {i.fname + " " + i.lname} </option>
                                                                </>
                                                            )
                                                        })
                                                    }
                                            ...
                                            <div className="col-lg-4 col-md-6 col-6">
                                                <select className="form-control" onChange={(i) => departSelectText(i.target.value)}>
                                            ...
                                            <div className="col-lg-4 col-md-6">
                                                <button className="btn btn-primary btn-round btn-block m-t-0 m-b-0" onClick={() => submitData()}>Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section className="main-section">
                            ...
                            <div className="container">
                                ...
                                <div className="row">
                                    <div className="col-md-4 col-sm-6">
                                        <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                            <div className="service-icon">
                                                <img src={require("../images/icon-cardio-monitoring.png")} alt="Cardio Monitoring" />
                                            </div>
                                    ...
                                    <div className="col-md-4 col-sm-6">
                                        <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                            <div className="service-icon">
                                                <img src={require('../images/icon-orthodontics.png')} alt="" />
                                            </div>
                                            <div className="service-cnt">
                                    ...
                                    <div className="col-md-4 col-sm-6">
                                        <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                            <div className="service-icon"><img src={require("../images/icon-traumatology.png")} alt="Traumatology" />
                                            </div>
                                            <div className="service-cnt">
                                    ...
                                    <div className="col-md-4 col-sm-6">
                                        <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                            <div className="service-icon"><img src={require("../images/icon-cardiology.png")} alt="Cardiology" />
                                            </div>
                                            <div className="service-cnt">
                                    ...
                                    <div className="col-md-4 col-sm-6">
                                        <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                            <div className="service-icon"><img src={require("../images/icon-prostheses.png")} alt="Prostheses" />
                                            </div>
                                            <div className="service-cnt">
                                    ...
                                    <div className="col-md-4 col-sm-6">
                                        <div className="service-box" data-aos="fade-up" data-aos-duration={3000}>
                                            <div className="service-icon"><img src={require("../images/icon-pulmonary.png")} alt="Pulmonary" /></div>
                                            <div className="service-cnt">
                        ...
                        <div className="our-team">
                            <div className="container">
                                ...
                                <div className="row">
                                    {
                                        allDoctors.slice(0, 4).map((i) => {
                                            return (
                                                <>
                                                    <div className="col-lg-3 col-md-6 col-sm-12">
                                                        <div className="team-box text-center" data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration={5000}>
                                                            <div className="doctor-pic"><img src={`http://localhost/PHP_Project/Hospital/images/${i.image}`} alt="Dr. John" /></div>
                                                            <div className="doctor-info">
                                                                <h4 style={{ textTransform: "capitalize" }}>Dr. {i.fname + " " + i.lname} <span> {i.speciality} </span></h4>
                                                                ...
                                                                <a className="btn btn-simple btn-primary btn-round" href={`/doctor-profile/${i.id}`}>View More</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </>
                                ...
                                <div className="row justify-content-between">
                                    ...
                                    <div className="col-lg-6 col-md-12">
                                        <div className="box-img" data-aos="fade-up" data-aos-duration={3000}>
                                            <img src={require("../images/why-choose-img.png")} alt />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="container">
                                ...
                                <div className="row" data-aos="flip-up">
                                    <div className="col-lg-4 col-md-6">
                                        <div className="blog-box">
                                            <div className="blog-img">
                                                <img src={require("../images/blog-1.png")} alt />
                                            </div>
                                    ...
                                    <div className="col-lg-4 col-md-6">
                                        <div className="blog-box">
                                            <div className="blog-img">
                                                <img src={require("../images/blog-2.png")} alt />
                                            </div>
                                            <div className="blog-cnt">
                                                <h5><a href="javascript:void(0);">How to handle your kids’ from Lorem ipsum dolor sit amet</a></h5>
                                                <p>The great explorer of the truth, master builder of human happiness one rejects,
                                    ...
                                    <div className="col-lg-4 d-none d-lg-block">
                                        <div className="blog-box">
                                            <div className="blog-img">
                                                <img src={require("../images/blog-3.png")} alt />
                                            </div>
                                            <div className="blog-cnt">
                                                <h5><a href="javascript:void(0);">How to handle your kids’ from Lorem ipsum dolor sit amet</a></h5>
                                                <p>The great explorer of the truth, master builder of human happiness one rejects,
