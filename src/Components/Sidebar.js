                            ...
                            <ul className="list">
                                <li>
                                    <div className="user-info">
                                        <div className="image">
                                            <a href="profile.html">
                                                <img src={require('../CSS/hospital management Admin/assets/images/profile_av.jpg')} alt="User" />
                                            </a>
                                        </div>
                                ...
                                <li className="active open"><a href="/home"><i className="zmdi zmdi-home" /><span>Dashboard</span></a></li>
                                ...
                                <li><a href="javascript:void(0);" className="menu-toggle"><i className="zmdi zmdi-account-o" /><span>Patients</span> </a>
                                    <ul className="ml-menu">
                                        ...
                                        <li><a href="/add-patients">Add Patient</a></li>
