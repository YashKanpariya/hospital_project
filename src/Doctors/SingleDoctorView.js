...
import '../CSS/hospital management Admin/light/assets/css/timeline.css'
...
function SingleDoctorView() {
    ...
    return (
        <>
            <div className='theme-cyan single-doctor'>
                <div>
                    {/* Page Loader */}
                                    ...
                                    <ul className="list">
                                        <li>
                                            <div className="user-info m-b-20 p-b-15">
                                                {
                                                    allDoctors.map((items) => {
                                                        if (items.id == window.localStorage.getItem('hs_user_id')) {
                                                            return (
                                                                <>
                                                                    <div className="image">
                                                                        <a href="profile.html">
                                                                            <img src={`http://localhost/PHP_Project/Hospital/images/${items.image}`} alt="User" />
                                                                        </a>
                                                                    </div>
                                                                    <div className="detail">
                                                                        <h4 style={{ textTransform: "capitalize" }}>Dr. {items.fname}</h4>
                                                                        <small> {items.speciality} </small>
                                                                    </div>
                                                                </>
                                                            )
                                                        }
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-4 p-r-0">
                                                        <h5 className="number count-to m-b-5" data-from={0} data-to={18} data-speed={2500} data-fresh-interval={1200}>18</h5>
                                                        <small>Exp</small>
                                                    </div>
                                                    <div className="col-4">
                                                        <h5 className="number count-to m-b-5" data-from={0} data-to={125} data-speed={2500} data-fresh-interval={1200}>125</h5>
                                                        <small>Awards</small>
                                                    </div>
                                                    <div className="col-4 p-l-0">
                                                        <h5 className="number count-to m-b-5" data-from={0} data-to={148} data-speed={2500} data-fresh-interval={1200}>148</h5>
                                                        <small>Clients</small>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="col-lg-4 col-md-12">
                                    <div className="card profile-header">
                                        <div className="body text-center">
                                            {
                                                allDoctors.map((items) => {
                                                    if (items.id == doctor_id) {
                                                        return (
                                                            <>
                                                                <div className="profile-image">
                                                                    <img src={`http://localhost/PHP_Project/Hospital/images/${items.image}`} alt />
                                                                </div>
                                                                <div>
                                                                    <h4 className="m-b-0" style={{ textTransform: "capitalize" }}><strong>Dr.  </strong> {items.fname} </h4>
                                                                    <span className="job_post"> {items.speciality} </span>
                                            ...
                                            {/* <div className="profile-image">
                                                <img src={require("../images/profile_av.jpg")} alt />
                                            </div>
                                            <div>
