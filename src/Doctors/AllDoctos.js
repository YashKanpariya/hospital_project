                                                                ...
                                                                <div className="card xl-blue member-card doctor">
                                                                    <div className="body">
                                                                        <div className="member-thumb">
                                                                            <img src={`http://localhost/PHP_Project/Hospital/images/${items.image}`} className="img-fluid" alt="profile-image" />
                                                                        </div>
                                                                        <div className="detail">
                                                                            <h4 className="m-b-0">Dr. {items.lname} <br /> {items.fname}</h4>
                                                                            <p className="text-muted"> {items.speciality} </p>
